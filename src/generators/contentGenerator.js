...
export class ContentGenerator {
    ...
    async generateArticle(options) {
        ...
        try {
            ...
            // 3. Создание frontmatter из шаблона
...
Верни теги через запятую без дополнительного текста.`;
     ...
     */
    async generateCompleteArticle(options) {
        const result = await this.generateArticle(options);
    ...
    /**
     * Получение статистики интеграции с блогом
     */
